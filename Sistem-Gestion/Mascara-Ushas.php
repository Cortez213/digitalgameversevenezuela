<?php
include 'conexion/conexion-mascara-ushas.php';
...
<div id="category-header">
    <div class="nav container">
        <a href="Todas-uhas.php" class="category-link">Todas</a>
        <a href="Labial-Ushas.php" class="category-link ">Labial</a> <!-- Añade la clase 'active' a la opción que quieres que se mantenga resaltada -->
        <a href="Base-Ushas.php" class="category-link ">Base</a>
        <a href="Delineador-Ushas.php" class="category-link">Delineador</a>
        <a href="Sombra-Ushas.php" class="category-link">Sombra</a>
        <a href="Mascara-Ushas.php" class="category-link active">Mascara</a>
        <a href="Polvo-Ushas.php" class="category-link" id="polvo-link">Polvo</a>
    </div>
</div>
<script>
