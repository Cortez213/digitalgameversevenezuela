<?php
include 'conexion/conexion-polvo-lancome.php';
...
document.querySelectorAll('.bx-shopping-bag').forEach((item) => {
    item.addEventListener('click', (event) => {
        ...
        const precio = parseFloat(productBox.querySelector('.product-price').textContent.slice(1));
        total += precio;
...
<div id="category-header">
    <div class="nav container">
        ...
        <a href="Labial-Lancóme.php" class="category-link ">Labial</a>
        ...
        <a href="Polvo-Lancóme.php" class="category-link active" id="polvo-link">Polvo</a>
    </div>
</div>
<script>
