<?php
include 'conexion/conexion-sombra-lancome.php';
...
<div id="category-header">
    <div class="nav container">
        ...
        <a href="Sombra-Lancóme.php" class="category-link active">Sombra</a>
        <a href="Iluminador-Lancóme.php" class="category-link ">Iluminador</a>
        <a href="Brochas-Lancóme.php" class="category-link">Brochas</a>
