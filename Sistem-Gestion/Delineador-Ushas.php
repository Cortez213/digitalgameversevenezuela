<?php
include 'conexion/conexion-delineador-ushas.php';
...
<div id="category-header">
    <div class="nav container">
        ...
        <a href="Labial-Ushas.php" class="category-link ">Labial</a>
        <a href="Base-Ushas.php" class="category-link ">Base</a>
        <a href="Delineador-Ushas.php" class="category-link active">Delineador</a>
