<?php
include 'conexion/conexion-brochas-lancome.php';
...
<div id="category-header">
    <div class="nav container">
        <a href="todas.php" class="category-link">Todas</a>
        ...
        <a href="Brochas-Lancome.php" class="category-link active ">Brochas</a>
