<?php
include 'conexion/conexion-labial-ushas.php';
...
<div id="category-header">
    <div class="nav container">
        ...
        <a href="Labial-Ushas.php" class="category-link active ">Labial</a> <!-- Añade la clase 'active' a la opción que quieres que se mantenga resaltada -->
        ...
        <a href="Mascara-Ushas.php" class="category-link">Mascara</a>
